...
router.get('/roi', function(req, res) {
  res.render('roi', { active: 'roi', address: settings.address, hashes: settings.api });
});

router.get('/map', function(req, res) {
  res.render('map', { active: 'map', address: settings.address, hashes: settings.api });
});
